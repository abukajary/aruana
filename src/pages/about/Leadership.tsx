  ...
  const adultSections: Section[] = [
    {
      ...
      content: [
        "Дорогие друзья,",
        "Добро пожаловать в Aruana Clinic – центр, где мы помогаем восстанавливать здоровье и возвращать радость движения. Наша команда врачей и реабилитологов ежедневно работает над тем, чтобы каждый пациент получал качественное лечение, внимательный уход и поддержку на пути к выздоровлению.",
        "Мы верим, что восстановление – это не только медицинский процесс, но и забота, мотивация и вера в успех. В Aruana Clinic мы создаем атмосферу, где каждый пациент чувствует себя уверенно и комфортно, а его индивидуальные потребности учитываются на каждом этапе лечения.",
        "Мы стремимся быть клиникой, где современные технологии сочетаются с искренним человеческим участием. Наша цель – не просто лечить, а дарить возможность жить полноценной жизнью.",
        "С уважением,",
        "Директор Aruana Clinic Малик Шынар Маликовна",
      ],
